...
describe User do
	...
	before { @user = User.new(name: "Tayyab", email: "tayyab@yahoo.com",
	...
	describe "when email format is valid" do
		it "should be valid" do
			addresses = %w[user@foo.COM A_US-ER@f.b.org first.1st@foo.jp
														a+b@baz.cn]
	...
	describe "when password is not present" do
		before do
			@user = User.new(name: "test", email: "test@a.com",
